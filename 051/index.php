...
<head>
    ...
    <style>
        body {
            background: linear-gradient(135deg, #ff1770ff, #36bcf1ff);
        ...
        .card-header {
            background: linear-gradient(135deg, #ff1770ff, #36bcf1ff) !important;
        ...
        .btn-warning {
            background-color: #9811d7ff;
            border-color: #9811d7ff;
