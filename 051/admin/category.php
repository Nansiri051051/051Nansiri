...
if ($category_name) {
    $stmt = $conn->prepare("INSERT INTO categoroies (category_name) VALUES (?)");
...
$_SESSION['error'] = "ไม่สำมำรถลบหมวดหมนู่ ไี้ ด ้เนอื่ งจำกยังมสี นิ คำ้ทใี่ ชง้ำนหมวดหมนู่ อี้ ย่" ;
} else {
