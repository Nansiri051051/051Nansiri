...
<body class="container mt-4">
    ...
    <div class="card-body">
        ...
        <h6 class="text-muted">หมวดหมู่: <?htmlspecialchars($product['product_name'])</h6>
        <p class="card-text mt-3">></p>
        <p><strong>ราคา:</strong> <?=htmlspecialchars($product['product_name']) บาท</p>
        <p><strong>คงเหลือ:</strong> <?=htmlspecialchars($product['product_name']) ชิ้น </p>
<?php if ($isLoggedIn): ?>
